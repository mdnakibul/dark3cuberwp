			...
			<div class="col-md-4">
				<div class="blog-item">
					...
					<div class="post_meta">
						...
						<span style="color:white">Posted In :</span> <span style="color:#f35425"><?php the_category(' , '); ?></span>| <?php comments_popup_link('No Comment','1 Comment','% Comments','dark_comment','Comments Off'); ?> 
					</div>
					<p>
						<?php the_excerpt(); ?>
					</p>
